...
--[[money.regular_add = function()
	for _,player in ipairs(minetest.get_connected_players()) do
		local name = player:get_player_name()
		money.add(name,40)
		minetest.chat_send_player(name, "You earned 40"..money.currency_name..", you now have "..money.get(name)..money.currency_name)
	end
	minetest.after(900,money.regular_add)
end
money.regular_add()]]
